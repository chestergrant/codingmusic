...
if(isset($_SESSION['userid'])){
    $random_video = $manager->getRandomFromUser($_SESSION['userid']);
...
<div style="width:600px;margin-left:auto;margin-right:auto;color:white">
               <?php if($no_playlist){ ?>
                        <p>Sorry you haven't added any music to your playlist.</p>
               <?php }else{ ?>
                        ...
                        <td>
                            <center><div class="comment-form-wrapper">
                                <form class="comment-form" id="feedbackFrm" name="feedbackFrm" method="post" >
                                  ...
                                  <table>
                                      <tr> 
                                          <td><input type="button" onclick="removePlaylist()" value="Remove" name="remove" id="remove" class="btn btn-submit" /></td>
                                          <td><input type="button" onclick="nextPlaylistVideo()" value="Next" name="next" id="next" class="btn btn-submit" /></td>
                                      </tr>
                                  </table>     
                                </form>
                            </div></center>
